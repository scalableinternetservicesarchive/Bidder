...
<<<<<<< HEAD
      post bid_items_url, params: { bid_item: { description: @bid_item.description, name: @bid_item.name, price: @bid_item.price } }
=======
...
<<<<<<< HEAD
    patch bid_item_url(@bid_item), params: { bid_item: { description: @bid_item.description, name: @bid_item.name, price: @bid_item.price } }
=======
